...
class User {
  ...
  render() {
    return `<center><h3 style="font-family: 'Black Ops One', cursive;"><li style="font-family: 'Black Ops One', cursive; text-align:left;">${this.user_name}- ${this.user_wins} win(s)</li></h3></center>`
  }
